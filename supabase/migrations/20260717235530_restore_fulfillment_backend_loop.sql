-- Repair remote schema drift for the fulfillment backend loop.
-- The migration history says 20260628001455 ran, but production was missing
-- fulfillment_appeals and system_settings. Keep this patch idempotent.
