...
## 前端协作
- **美学规范权威文件**：`docs/美学规范.md`（项目内唯一版本）。所有前端改造前必读。旧的 `docs/美学标准.md`、`docs/美学准则.md`、`docs/DYData-实际风格需求汇总.md`、`docs/全站美学合规扫描报告-V1.2.md` 以及 `~/.claude/memory/阿禅美学*` 均已废止；历史方案和计划文档仅作归档参考。
- 分工（2026-05-10 锁定）：
