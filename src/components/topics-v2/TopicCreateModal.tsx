...
export function TopicCreateModal({
  ...
  return (
    ...
    >
      <DialogContent className="flex max-h-[calc(100dvh-2rem)] flex-col overflow-hidden rounded-2xl border border-[#E2E2DF] bg-white/95 p-6 shadow-claude-dialog sm:max-w-lg">
          ...
          <DialogBody className="min-h-0 flex-1 space-y-4 overflow-y-auto py-1 pr-1">
              ...
              {isSmartPasteOpen && (
                <div className="space-y-2 pt-0.5">
                  <textarea
                    ...
                    className="w-full rounded-xl border border-[#E2E2DF] bg-white/50 focus:bg-white p-3 text-xs text-[#292524] placeholder:text-[#A8A29E] focus:outline-none focus:border-[#78716C] focus:ring-1 focus:ring-[#D97757]/20 shadow-input resize-none transition-all"
                  />
            ...
            <div>
              ...
              >
                <SelectTrigger
                  aria-label="选择所属母题"
                  className="w-full rounded-lg border border-[#E2E2DF] bg-white/50 px-3 py-2 text-[13px] font-normal text-[#292524] shadow-input hover:border-[#78716C]/40 focus-visible:border-[#78716C] focus-visible:bg-white focus-visible:ring-1 focus-visible:ring-[#D97757]/25"
                >
                  <SelectValue>
                    {topicId
                ...
                <SelectContent className="min-w-44 rounded-xl border border-[#E2E2DF] shadow-claude-float">
                  {topics.map((topic) => (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-[#E2E2DF] bg-white/50 px-3 py-2 text-[13px] font-normal text-[#292524] shadow-input placeholder:text-[#78716C]/60 hover:border-[#78716C]/40 focus-visible:border-[#78716C] focus-visible:bg-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#D97757]/25 focus-visible:ring-offset-0"
                required
