        ...
        {screenshotsRequired ? (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex flex-col gap-0.5 text-[12px] leading-relaxed text-zinc-500">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  slot.status === "empty" ? "border-zinc-300 border-dashed bg-zinc-100/20" : "border-zinc-300 shadow-sm",
              ...
              >
                ...
                <div className="flex min-w-0 items-start justify-between gap-2.5">
                  <div className="flex min-w-0 items-center gap-2.5">
                    {/* 缩略图 */}
                    {slot.status === "empty" ? (
                      <div className="flex size-11 shrink-0 items-center justify-center rounded-lg border border-dashed border-zinc-300 bg-zinc-100 text-zinc-500">
                        <FileText className="size-4.5 stroke-[1.5]" />
                      </div>
                    ) : isProcessing ? (
                      <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-zinc-100 text-[#D97757]">
                      ...
                      <Dialog>
                        <DialogTrigger
                          render={
                            <div className="group/preview relative size-11 shrink-0 cursor-zoom-in overflow-hidden rounded-lg border border-zinc-300">
                              <img
                                src={slot.assetUrl}
                                alt={item.title}
                      ...
                      <div className="flex size-11 shrink-0 items-center justify-center rounded-lg bg-zinc-200 text-zinc-500">
                        <FileText className="size-4.5 stroke-[1.5]" />
                      </div>
                    )}
                    ...
                    <div className="min-w-0">
                      <span className="text-[12px] font-medium text-zinc-700 block leading-none">{item.title}</span>
                      {slot.status !== "empty" && (
                        <span
                          className={cn(
                  ...
                  <div className="flex shrink-0 items-center gap-1">
                      ...
                      <>
                        {onRetry && (
                          <button
                            ...
                            className="inline-flex size-6 items-center justify-center rounded-lg bg-zinc-100 hover:bg-zinc-200 text-zinc-700 border border-zinc-300 transition-colors"
                            title="重新识别"
                          >
                    ...
                    {slot.status !== "empty" && !isProcessing && (
                      <button
                        ...
                        className="inline-flex size-6 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-200 hover:text-[#C9604D] transition-colors"
                        title="删除"
                      >
                ...
                {/* 下半部：文件名或解析结果 */}
                <div className="text-[12px] text-zinc-500 truncate mt-1">
                  {slot.status === "empty"
