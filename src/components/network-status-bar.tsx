...
export function NetworkStatusBar() {
  ...
  return (
    <div
      className={cn(
        "fixed inset-x-0 top-0 z-[60] flex h-8 items-center justify-center text-[13px] font-medium text-white transition-[background-color,color,border-color,transform,box-shadow] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)]",
        bgColor,
      )}
      role="status"
      aria-live="polite"
