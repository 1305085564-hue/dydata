...
export function ChartSkeleton({ className }: ChartSkeletonProps) {
  return (
    <div
      className={cn(
        "chart-skeleton relative flex h-full w-full overflow-hidden rounded-2xl border border-[#E2E2DF] bg-[#FCFCFB] p-4 sm:p-5",
        className
      )}
    >
      ...
      <div className="relative flex-1 overflow-hidden rounded-2xl border border-border/40 bg-muted/[0.14] px-4 py-5">
        ...
        <svg aria-hidden="true" viewBox="0 0 320 180" className="h-full w-full text-[#E2E2DF]">
          <defs>
