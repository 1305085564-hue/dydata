  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <aside
        ...
        aria-label="今日待办"
        className={cn(
          "absolute right-0 top-0 flex h-full w-full max-w-[480px] flex-col border-l border-stone-200 bg-stone-50 shadow-xl",
      ...
      >
        <header className="flex shrink-0 items-center justify-between border-b border-stone-200 bg-white px-5 py-4">
          <div>
            <div className="text-[12px] font-medium uppercase tracking-[0.25em] text-stone-500">Today</div>
            <h2 className="mt-1 text-[18px] font-medium tracking-tight text-stone-900">今日待办</h2>
          </div>
          <button
            type="button"
            onClick={() => onOpenChange(false)}
            aria-label="关闭"
            className="inline-flex size-8 items-center justify-center rounded-lg border border-stone-200 bg-white text-stone-500 transition-[color,background-color,border-color] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-stone-300 hover:bg-stone-50 hover:text-stone-900 active:translate-y-0"
          >
