  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 border-zinc-200 bg-white text-[13px] text-zinc-700 shadow-sm outline-none duration-200 ease-[cubic-bezier(0.4,0,0.2,1)]",
          sideClasses[side],
          className,
        )}
        {...props}
...
function SheetTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-[18px] font-semibold leading-none tracking-tight text-zinc-950",
        className,
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-[13px] leading-[1.6] text-zinc-600", className)}
      {...props}
    />
  )
}
