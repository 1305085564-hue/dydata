  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-md border border-transparent px-2 py-0.5 text-[12px] font-medium tracking-tight whitespace-nowrap transition-[background-color,color,border-color] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus-visible:ring-1 focus-visible:ring-[#1C1917]/5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&>svg]:pointer-events-none [&>svg]:size-3! [&>svg]:stroke-[1.5] tabular-nums",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-[#F1F1F0] text-[#C9604D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#C9604D] before:inline-block",
        outline: "border-[#E2E2DF] text-[#292524]",
        ghost: "hover:bg-[#EBEBE9] hover:text-[#292524]",
        link: "text-[#D97757] underline-offset-4 hover:underline",
        success: "bg-[#F1F1F0] text-[#6FAA7D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#6FAA7D] before:inline-block",
        danger: "bg-[#F1F1F0] text-[#C9604D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#C9604D] before:inline-block",
        neutral: "bg-[#F1F1F0] text-[#78716C] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#78716C] before:inline-block",
        warning: "bg-[#F1F1F0] text-[#B98A54] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#B98A54] before:inline-block",
