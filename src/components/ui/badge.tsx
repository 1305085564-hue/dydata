  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-[12px] font-medium tracking-tight whitespace-nowrap transition-[background-color,color,border-color] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus-visible:ring-1 focus-visible:ring-stone-950/5 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&>svg]:pointer-events-none [&>svg]:size-3! [&>svg]:stroke-[1.5] tabular-nums",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-stone-50 text-[#C9604D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#C9604D] before:inline-block",
        ...
        success: "bg-stone-50 text-[#6FAA7D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#6FAA7D] before:inline-block",
        danger: "bg-stone-50 text-[#C9604D] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#C9604D] before:inline-block",
        ...
        warning: "bg-stone-50 text-[#D99E55] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#D99E55] before:inline-block",
        accent: "bg-[#4F5E96]/[0.12] text-[#4F5E96] before:mr-1 before:size-1.5 before:rounded-full before:bg-[#4F5E96] before:inline-block",
      },
    },
    defaultVariants: {
      variant: "default",
