...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-[16px] leading-none font-semibold tracking-tight text-zinc-800", className)}
      {...props}
    />
  )
}
