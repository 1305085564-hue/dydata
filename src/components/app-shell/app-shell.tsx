  ...
  return (
    <div className={cn("app-shell-header-row", className)}>
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          <h1 className="app-shell-title app-shell-heading font-serif text-xl sm:text-[1.75rem] leading-[1.20] font-medium tracking-tight text-[#1C1917]">{title}</h1>
...
export function AppShell({ children, className, width = "wide" }: AppShellProps) {
  return <div className={cn("app-shell-frame min-h-screen min-h-dvh space-y-5 sm:space-y-6", widthMap[width], className)}>{children}</div>
}

export function AppShellHero({ children, className, bodyClassName, ...props }: AppShellHeroProps) {
  return (
    <section className={cn("app-shell-hero border-b border-[#E2E2DF]/80 pb-8", className)}>
...
export function AppShellSection({ children, className, bodyClassName, divider = false, ...props }: AppShellSectionProps) {
  return (
    <section className={cn("app-shell-section border-b border-[#E2E2DF]/80 pb-8", className)}>
      <div className={cn("space-y-4", bodyClassName)}>
        <ShellHeader {...props} />
