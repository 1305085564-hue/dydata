...
export function AppShellHero({ children, className, bodyClassName, ...props }: AppShellHeroProps) {
  return (
    <section className={cn("app-shell-hero overflow-hidden rounded-2xl border border-stone-200 bg-white", className)}>
...
export function AppShellSection({ children, className, bodyClassName, divider = false, ...props }: AppShellSectionProps) {
  return (
    <section className={cn("app-shell-section overflow-hidden rounded-2xl border border-stone-200 bg-white", className)}>
