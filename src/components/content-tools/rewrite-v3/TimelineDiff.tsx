    ...
    <div className="shrink-0 bg-white/70 backdrop-blur-md border-b border-[#E5E0D6] px-5 py-2.5 flex items-center justify-between z-30 h-[48px] select-none">
      <div className="flex items-center gap-4 max-w-[70%] min-w-0">
        ...
        <div className="flex items-center gap-1.5 shrink-0 select-none">
          ...
          <span className="text-[12px] font-medium text-[#292524] font-sans tracking-wide">
            版本时光机
          </span>
          <span className="text-[12px] font-medium text-[#78716C] hidden sm:inline">
            (点击圆点回溯)
          </span>
        </div>
            ...
            {completedRevisions.map((rev, index) => {
              ...
              return (
                <button
                  ...
                  className="group relative h-8.5 w-8.5 shrink-0 rounded-full flex items-center justify-center transition-colors duration-100 active:scale-[0.99] active:duration-120 focus:outline-none focus-visible:ring-1 focus-visible:ring-[#D97757]/25 focus-visible:ring-offset-0"
                >
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        {!isViewingLatest && currentSelectedRevision && (
          <button
            ...
            className="inline-flex items-center gap-1 bg-[#D97757] text-white hover:bg-[#C96442] font-medium text-[12px] px-2.5 py-1 rounded-lg shadow-sm shadow-[#D97757]/20 transition-all duration-200 active:scale-[0.99] active:duration-120"
