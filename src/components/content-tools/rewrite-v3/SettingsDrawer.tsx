            ...
            <div className="space-y-3 animate-in fade-in duration-200">
              ...
              <label className="block space-y-1">
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full bg-zinc-100/50 border border-transparent focus:bg-white focus:border-zinc-200 rounded-lg p-2.5 text-[12px] leading-relaxed outline-none focus:ring-1 focus:ring-zinc-900/10"
          ...
          <div className="space-y-4 animate-in fade-in duration-200">
            ...
            <div className="border border-zinc-200 bg-white p-4 rounded-lg space-y-3 shadow-sm">
              ...
              <div className="space-y-1.5">
                ...
                />
                <div className="flex justify-between text-[12px] font-medium text-zinc-500 tabular-nums">
                  <span>2轮</span>
                  <span>4轮</span>
                  <span>6轮</span>
                  <span>8轮</span>
