    ...
    <div className="flex-1 flex flex-col min-h-0 bg-transparent relative">
      ...
      <div className="shrink-0 bg-white/80 backdrop-blur-md border-t border-zinc-200/50 p-4 relative z-20">
        <div className="max-w-xl mx-auto space-y-2">
          ...
          {/* 核心输入框容器 */}
          <div className="relative flex items-end gap-2 rounded-lg border border-transparent bg-zinc-100/50 p-1.5 transition-all duration-200 focus-within:border-zinc-300 focus-within:bg-white focus-within:shadow-md focus-within:ring-2 focus-within:ring-[#5F82A8]/30">
            <textarea
              ref={textareaRef}
              value={inputText}
