    ...
    <div className="flex-1 flex flex-col min-h-0 bg-transparent relative">
      ...
      <div className="shrink-0 h-[44px] px-4 border-b border-[#E5E0D6] bg-transparent flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex h-7 items-center gap-1.5 rounded-lg border border-[#E5E0D6] bg-white px-2.5 text-[12px] font-medium text-[#292524] transition-all hover:bg-[#FBF9F5] hover:text-[#1C1917] active:scale-[0.985] active:duration-75"
          title="打开参数与技能设置"
        >
              ...
              return (
                ...
                >
                  ...
                  {isUser ? (
                    ...
                    <div className="flex-1 max-w-[85%] text-[13px] leading-relaxed text-[#292524] select-text pr-4 py-0.5">
        ...
        <div className="max-w-xl mx-auto space-y-2">
            ...
            <div className="flex items-start justify-between bg-[#FBF9F5] border border-[#E5E0D6] p-2.5 rounded-lg text-[#292524] text-[12px] shadow-sm animate-in slide-in-from-bottom-2 duration-200">
              <div className="flex items-start gap-2 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  <span className="text-[12px] uppercase font-medium tracking-wider text-[#78716C] block mb-0.5">引用段落</span>
                  <p className="line-clamp-2 font-medium leading-relaxed text-[#292524]">&quot;{referredText}&quot;</p>
                </div>
              </div>
              <button
                onClick={onClearReferredText}
                className="shrink-0 rounded-full p-0.5 hover:bg-[#E5E0D6] text-[#78716C] hover:text-[#292524] transition-colors"
                title="清除引用"
                aria-label="清除引用"
              >
                <X className="h-3 w-3" />
          ...
          <div className="relative flex items-end gap-2 rounded-lg border border-transparent bg-[#F5F3EE]/50 p-1.5 transition-all duration-200 focus-within:border-[#E5E0D6] focus-within:bg-white focus-within:shadow-md focus-within:ring-2 focus-within:ring-[#43718E]/30">
            ...
            <button
              ...
              className={cn(
                'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-all duration-200 active:scale-[0.985] active:duration-75',
                isSending
          ...
          <div className="flex items-center justify-between px-1 text-[12px] font-medium tracking-wider text-[#78716C]">
