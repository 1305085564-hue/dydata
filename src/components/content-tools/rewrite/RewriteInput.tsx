      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <p className="text-[12px] font-medium uppercase tracking-[0.25em] text-stone-400">选择改写套餐</p>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      interactionControlsDisabled
                        ...
                        : active
                          ? 'border-stone-300 bg-white text-stone-800 shadow-sm ring-1 ring-stone-950/5'
          ...
          <div className="rounded-lg border border-stone-200 bg-stone-50 p-4">
            <div className="mb-4 flex items-center gap-2 text-[13px] font-semibold text-stone-800">
            ...
            <div className="space-y-4">
              <label className="block space-y-1.5">
                <span className="text-[12px] font-medium uppercase tracking-[0.25em] text-stone-400">真实模型</span>
                <select
                  ...
                  className={cn(
                    ...
                    customControlsLocked
                      ...
                      : 'border-stone-200 text-stone-800 focus-visible:ring-1 focus-visible:ring-stone-950/5',
                  )}
                >
              ...
              <label className="block space-y-1.5">
                <span className="text-[12px] font-medium uppercase tracking-[0.25em] text-stone-400">普通模式</span>
                <select
              ...
              <label className="block space-y-1.5">
                <span className="text-[12px] font-medium uppercase tracking-[0.25em] text-stone-400">字数</span>
                <select
      ...
      <div className="border-t border-stone-200 bg-white p-4">
        <div className="relative rounded-lg border border-stone-200 bg-stone-50 p-1 transition-[background-color,color,box-shadow,transform] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus-within:border-stone-300 focus-within:bg-white focus-within:ring-1 focus-within:ring-stone-950/5">
          <textarea
            ...
            className={cn(
              'min-h-[120px] w-full resize-none bg-transparent px-3 py-3 text-[14px] leading-[1.7] text-stone-800 outline-none placeholder:text-stone-400',
