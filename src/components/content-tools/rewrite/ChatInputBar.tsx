  ...
  return (
    <div className="shrink-0 bg-transparent px-4 pb-6 pt-2 relative z-20">
      <div className="mx-auto max-w-3xl relative">
        ...
        {/* Skill Popover */}
        {showSkillPopover && (
          <div className="absolute bottom-full left-0 mb-3 w-64 rounded-2xl border border-white/20 bg-white/85 backdrop-blur-xl p-1.5 shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
