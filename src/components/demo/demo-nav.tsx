...
import { LayoutPanelTop, Lock, Shield, Sparkles } from "lucide-react";
    ...
    <nav className="app-toolbar fixed inset-x-0 top-0 z-40 pt-[max(env(safe-area-inset-top),0px)]">
      <div className="mx-auto px-3 sm:px-6">
        <div className="app-toolbar-inner flex min-h-[var(--app-nav-height)] items-center gap-3 px-3 py-2 sm:gap-4 sm:px-3.5">
          ...
          <div className="hidden shrink-0 items-center gap-2 rounded-full border border-border/70 bg-background/60 px-3 py-1.5 text-xs text-muted-foreground shadow-[var(--shadow-light)] md:flex">
