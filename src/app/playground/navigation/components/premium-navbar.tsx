      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4">
                  ...
                  >
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute inset-0 bg-zinc-100/80 dark:bg-zinc-900/60 rounded-lg"
                      />
                    )}
          ...
          <div className="flex items-center gap-3 shrink-0 ml-auto">
            ...
            <div className="relative flex items-center bg-zinc-100 dark:bg-zinc-900 p-0.5 rounded-xl border border-zinc-200/20 shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)]">
              ...
              <button
                ...
                className={cn(
                  ...
                  perspective === "user" ? "text-zinc-900 dark:text-white" : "text-zinc-500 hover:text-zinc-700"
                )}
              >
                {perspective === "user" && (
                  <motion.div
              ...
              <button
                ...
                className={cn(
                  "relative z-10 px-3 py-1 text-[11px] font-semibold rounded-lg transition-colors duration-200",
                  perspective === "admin" ? "text-zinc-900 dark:text-white" : "text-zinc-500 hover:text-zinc-700"
                )}
              >
                {perspective === "admin" && (
                  <motion.div
            ...
            {/* Separator */}
            <div className="hidden md:block h-5 w-[1px] bg-zinc-200 dark:bg-zinc-800" />
