        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="h-9 text-[12px] font-medium text-stone-500">下滑幅度</TableHead>
              <TableHead className="h-9 text-[12px] font-medium text-stone-500">最近视频表现</TableHead>
              <TableHead className="h-9 text-[12px] font-medium text-stone-500">触发原因</TableHead>
                ...
                <TableCell className="align-top">
                  <div className="flex flex-wrap gap-1.5">
                    {item.reasons.map((reason) => (
                      <Badge key={reason} variant="outline" className="border-stone-200 bg-[#C9604D]/10 text-[12px] text-[#C9604D]">
                        {reason}
                      </Badge>
                    ))}
                  </div>
