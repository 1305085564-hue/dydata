    ...
    <>
      <div className="space-y-3">
        <div className="flex items-baseline gap-3">
          <h2 className="text-[13px] font-medium tracking-tight text-zinc-700">日常管理</h2>
        </div>
        <AdminSecondaryNav
          pathname="/admin"
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-[12px] font-medium text-zinc-900 transition-[background-color,color,box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] active:translate-y-0"
                      >
                        打开独立页面
                      </Link>
                    </div>
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-6 lg:px-7">
                <div className="mx-auto w-full max-w-[1760px]">
                  <div className="mb-4 rounded-xl border border-zinc-200 bg-white px-4 py-3">
                    <p className="text-[13px] font-medium text-zinc-900">{activeItem.label}</p>
