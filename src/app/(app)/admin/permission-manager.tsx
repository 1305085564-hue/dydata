...
function MemberRow({ member, isActive, disabled, onClick }: MemberRowProps) {
  ...
  return (
    ...
    >
      <span className="truncate font-medium text-zinc-900" title={member.name}>
        {member.name}
      </span>
      <span className="hidden lg:inline truncate text-zinc-500" title={currentTeamName}>
        {currentTeamName}
      </span>
      ...
      <ChevronRight
        className={cn(
          "size-4 stroke-[1.5] text-zinc-500/40 transition-colors duration-150",
    ...
    <div className="space-y-6 rounded-2xl border border-zinc-200 bg-white p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 flex-wrap items-center gap-4">
          <Label
            htmlFor="team-filter"
            className="text-[12px] font-normal uppercase tracking-[0.25em] text-zinc-500"
          >
            团队
          </Label>
          <Select
          ...
          >
            <SelectTrigger
              id="team-filter"
              className="h-9 w-[150px] border-transparent bg-zinc-50 transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus:border-zinc-500 focus:bg-white focus:shadow-sm focus:ring-1 focus:ring-zinc-900/5"
            >
          ...
          <Input
            ...
            className="h-9 w-full rounded-xl border-transparent bg-zinc-50 transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus:border-zinc-500 focus:bg-white focus:shadow-sm focus:ring-1 focus:ring-zinc-900/5 sm:w-64"
          />
        </div>
      ...
      {filteredMembers.length === 0 ? (
        <p className="py-10 text-center text-[13px] text-zinc-500">暂无可管理成员</p>
      ) : (
        <>
          <div className="grid grid-cols-1 gap-x-[146px] px-4 pb-2 text-[12px] font-normal uppercase tracking-[0.25em] text-zinc-500 lg:grid-cols-2">
            <div className="grid grid-cols-[1fr_auto_44px_16px] lg:grid-cols-[1.4fr_1.4fr_1fr_44px_16px] items-center gap-x-4 lg:gap-x-6 border-b border-zinc-200 pb-2">
              <span>姓名</span>
            ...
            <div className="hidden grid-cols-[1fr_auto_44px_16px] lg:grid-cols-[1.4fr_1.4fr_1fr_44px_16px] items-center gap-x-4 lg:gap-x-6 border-b border-zinc-200 pb-2 lg:grid">
              <span>姓名</span>
              <span className="hidden lg:inline">团队</span>
              <span className="text-center">角色</span>
              <span className="text-right">权限</span>
            ...
            <>
              ...
              <SheetBody className="space-y-6">
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="rounded-lg p-1 text-zinc-500 transition-colors hover:bg-zinc-200/50 hover:text-zinc-700"
                      >
                ...
                <section className="space-y-4 border-t border-zinc-200 pt-6">
                  ...
                  <div className="space-y-2">
                    <Label id="member-role-label" className="text-[12px] text-zinc-700">角色</Label>
                    <Select
                    ...
                    >
                      <SelectTrigger aria-labelledby="member-role-label" className="h-9 border-zinc-200 bg-white text-[13px]">
                        <SelectValue>
                  ...
                  <div className="space-y-2">
                    <Label id="member-team-label" className="text-[12px] text-zinc-700">团队</Label>
                    <Select
                    ...
                    >
                      <SelectTrigger aria-labelledby="member-team-label" className="h-9 border-zinc-200 bg-white text-[13px]">
              ...
              <SheetFooter className="flex-col items-stretch gap-2">
                ...
                <div className="flex justify-end gap-2">
                  <Button
                    variant="ghost"
                    className="h-9 px-3 text-[12px] text-zinc-500 hover:text-zinc-900"
                    onClick={() => {
                      if (hasDraftChanges) {
                        handleResetDraft();
                      }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="rounded-xl border-transparent bg-zinc-50 transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus:border-zinc-500 focus:bg-white focus:shadow-sm focus:ring-1 focus:ring-zinc-900/5"
              />
            </div>
            <div className="space-y-2">
