    ...
    return (
      <section className="flex items-center justify-between rounded-2xl border border-zinc-200 bg-white px-5 py-3">
        <div className="flex items-center gap-2">
          <UserPlus className="size-4 text-zinc-500" strokeWidth={1.5} />
          <span className="text-[13px] font-medium text-zinc-900">入团申请审核</span>
        </div>
  ...
  if (count === 0) {
    return (
      <section className="flex items-center justify-between rounded-2xl border border-zinc-200 bg-white px-5 py-3">
        ...
        <span className="text-[12px] text-zinc-500">暂无待审申请</span>
      </section>
    );
  }
  ...
  return (
    <section className="rounded-2xl border border-zinc-200 bg-white p-6">
      <div className="flex items-baseline gap-3">
        <h2 className="text-[18px] font-medium tracking-tight text-zinc-900">入团申请审核</h2>
...
function JoinRequestReviewSkeleton() {
  return (
    <section className="rounded-2xl border border-zinc-200 bg-white p-6">
      <div className="flex items-baseline gap-3">
        <h2 className="text-[18px] font-medium tracking-tight text-zinc-900">入团申请审核</h2>
        <span className="inline-flex items-center rounded-full bg-zinc-100 px-2 py-0.5 text-[12px] font-medium text-zinc-500">
          加载中
        </span>
      </div>
