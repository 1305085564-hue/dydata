...
export default function ChatPanel({
 ...
 className="group relative overflow-hidden rounded-2xl border border-zinc-200 bg-white p-4 text-left shadow-[0_1px_0_rgba(0,0,0,0.02)] transition-[background-color, color, box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-zinc-300 "
                  >
              ...
              <div className="mt-8 flex items-center justify-center gap-4 text-[10px] uppercase tracking-[0.2em] text-zinc-400">
                <span className="flex items-center gap-1.5">
                  <kbd className="rounded border border-zinc-200 bg-white px-1.5 py-0.5 font-mono text-[12px] font-medium text-zinc-500 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
                    Enter
                  </kbd>
                  <span>发送</span>
                </span>
 ...
 className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-2.5 py-1 text-[11px] font-medium text-zinc-600 transition-[background-color, color, box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-zinc-300 hover:text-zinc-800 active:translate-y-0"
                        >
          ...
          <div className="mt-2 flex items-center justify-between px-2">
            <div className="flex items-center gap-2">
              <button
                ...
                className="active:translate-y-0 lg:hidden inline-flex items-center gap-1.5 text-[10.5px] uppercase tracking-[0.2em] text-zinc-400 transition-colors hover:text-zinc-700"
              >
