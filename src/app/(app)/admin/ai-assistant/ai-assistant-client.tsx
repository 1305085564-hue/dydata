...
export default function AIAssistantClient({ actorRole }: Props) {
  ...
  return (
    <div className="flex h-[100dvh] w-full flex-col overflow-hidden bg-[var(--color-bg)]">
      {/* Top bar */}
      <header className="relative z-10 flex h-12 shrink-0 items-center justify-between border-b border-zinc-200 bg-[var(--color-bg)] px-3">
 ...
 className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-2.5 py-1 text-[11px] font-medium text-zinc-600 shadow-[0_1px_0_rgba(0,0,0,0.02)] transition-[background-color, color, box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] hover:border-zinc-300 hover:text-zinc-800 active:translate-y-0"
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        ...
        <aside
          className={cn(
            "relative hidden shrink-0 flex-col border-r border-zinc-200 bg-[var(--color-bg)] transition-[width] duration-300 ease-out lg-flex",
