        ...
        <div className="flex flex-wrap items-center gap-2 rounded-xl border border-zinc-200 bg-white p-1">
          <button
            className={cn(
              ...
              type === "week" ? "bg-white text-zinc-900 border border-zinc-200" : "text-zinc-700 hover:bg-zinc-100"
            )}
          ...
          <button
            className={cn(
              "rounded-lg px-4 py-1.5 text-[12px] font-medium transition-[background-color,color] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)]",
              type === "month" ? "bg-white text-zinc-900 border border-zinc-200" : "text-zinc-700 hover:bg-zinc-100"
            )}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <p className="mb-1 text-[12px] font-normal tracking-[0.12em] text-zinc-500">建议行动</p>
                        <p className="text-[13px] leading-[1.7] text-zinc-700">{insight.best_direction.recommendation}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <p className="mb-1 text-[12px] font-normal tracking-[0.12em] text-zinc-500">建议行动</p>
                        <p className="text-[13px] leading-[1.7] text-zinc-700">{insight.worst_direction.recommendation}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {insight.validated_experiments && insight.validated_experiments.length > 0 && (
                <div className="rounded-xl border border-zinc-200 bg-white p-5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="text-[13px] font-medium text-zinc-900">已验证测试结论</h4>
                  </div>
                  <ul className="space-y-2">
                    {insight.validated_experiments.map((exp, idx) => (
                      <li key={idx} className="flex items-start gap-2 text-[13px] leading-[1.7] text-zinc-700">
