  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        ...
        {lockedSubmitter ? (
          <div className="flex flex-wrap items-center gap-2 rounded-r-xl border-l-2 border-l-[#D97757] bg-amber-50/40 px-3 py-2 text-[12px] text-zinc-700">
            <span className="font-medium">当前已锁定成员：</span>
            <span className="rounded-full bg-white px-3 py-1 font-medium text-zinc-700">{lockedSubmitter}</span>
