...
function getIntensityClass(value: number | null, max: number) {
  ...
  if (ratio > 0.45) return "border-[#D97757]/30 bg-[#D97757]/25 text-zinc-900";
  if (ratio > 0.2) return "border-[#D99E55]/30 bg-[#D99E55]/15 text-zinc-900";
    ...
    <div className="space-y-4">
      <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)]">
        <div className="space-y-1">
          <h3 className="text-[16px] font-medium tracking-tight text-zinc-900">时间维度分析</h3>
          <p className="max-w-2xl text-[13px] leading-[1.7] text-zinc-600">
        ...
        <div
          className={cn(
            ...
            recommendationMeta.hasRecommendation
              ? "rounded-r-xl border-l-2 border-l-[#D97757] bg-amber-50/40"
              : "rounded-xl bg-zinc-100/70",
          )}
        >
          <div
            className={cn(
              ...
              <div>
                ...
                <p
                  className={cn(
                    ...
                    recommendationMeta.hasRecommendation ? "text-zinc-900" : "text-zinc-900",
                  )}
                >
      ...
      <div className="grid items-start gap-4 xl:grid-cols-[minmax(0,1.45fr)_minmax(280px,0.55fr)]">
          ...
          <div className="overflow-x-auto pb-1">
            <div className="min-w-[760px]">
              ...
              >
                <div />
                {HOURS.map((hour) => (
                  <div key={hour} className="text-center text-[12px] font-normal text-zinc-500">
              ...
              <div className="space-y-1">
                {WEEKDAYS.map((day, weekdayIndex) => (
                  <div
                    ...
                    style={{ gridTemplateColumns: "56px repeat(24, minmax(18px, 1fr))" }}
                  >
                    <div className="pr-1 text-[13px] font-medium text-zinc-700">{day}</div>
                    {HOURS.map((hour) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "group relative aspect-square min-h-5 rounded-lg border transition duration-200 focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:shadow-sm focus-visible:ring-1 focus-visible:ring-zinc-900/5",
        ...
        <aside className="space-y-2.5 self-start rounded-2xl border border-zinc-200 bg-white p-3 shadow-[var(--shadow-card)] ">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 text-[12px] font-normal tracking-[0.12em] text-zinc-500">
          ...
          {activeCell && activeSummary ? (
              ...
              <div className="space-y-1">
                <div
                  className={cn(
                    ...
                    activeIsRecommended
                      ? "bg-emerald-50 text-[#16A34A] font-medium"
            ...
            <div className="rounded-xl bg-zinc-100/60 p-4 text-[13px] text-zinc-600">
              点击任意热力单元格查看该时段表现。
            </div>
          )}
        </aside>
