...
export function ActionHub({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white p-6">
      <h2 className="text-[18px] font-semibold tracking-tight text-zinc-900">工作流中心</h2>

      <div className="mt-5 space-y-5">
        <div>
          <p className="text-[12px] uppercase tracking-[0.25em] font-medium text-zinc-500">优先待办</p>
          <div className="mt-3">
            {canManageMembers ? (
              <Dialog
              ...
              >
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 line-clamp-2 text-[12px] leading-[1.7] text-zinc-500">
                ...
                <DialogContent className="max-w-[min(960px,calc(100vw-2rem))] rounded-2xl border border-zinc-200 bg-white p-0 shadow-lg">
                  <div className="space-y-4 p-5 sm:p-6">
                    ...
                    <div className="max-h-[65vh] overflow-auto rounded-xl border border-zinc-200 bg-white p-4">
                      <豁免申请列表
        ...
        <div>
          <p className="text-[12px] uppercase tracking-[0.25em] font-medium text-zinc-500">快捷动作</p>
          <div className="mt-3">
              ...
              validQuickActions.map((item) => (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <p className="text-[13px] text-zinc-700">{item.label}</p>
                  </div>
                  <ChevronRight className="size-4 text-zinc-500 stroke-[1.5]" />
                </Link>
              ))
            ) : (
              <p className="py-2 text-[13px] text-zinc-500">
                暂无推荐快捷操作
              </p>
            )}
          </div>
