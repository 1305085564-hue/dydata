  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-5 space-y-5">
        <div>
          <p className="text-[10px] uppercase tracking-[0.25em] font-medium text-zinc-400">优先待办</p>
          <div className="mt-3">
            {canManageMembers ? (
              <Dialog
              ...
              >
                ...
                <DialogContent className="max-w-[min(960px,calc(100vw-2rem))] rounded-2xl border border-zinc-200 bg-white p-0 shadow-sm">
        ...
        <div>
          <p className="text-[10px] uppercase tracking-[0.25em] font-medium text-zinc-400">快捷动作</p>
          <div className="mt-3">
            {validQuickActions.length > 0 ? (
              validQuickActions.map((item) => (
                ...
                >
                  ...
                  <ChevronRight className="size-4 text-zinc-400 stroke-[1.5]" />
                </Link>
              ))
            ) : (
