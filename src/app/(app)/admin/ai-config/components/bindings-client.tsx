              ...
              bundle.featureBindings.map((binding) => (
                <TableRow key={binding.id}>
                  ...
                  <TableCell className="text-right">
                    ...
                    <Button variant="ghost" size="icon" aria-label={`删除绑定 ${binding.label}`} className="size-8 text-stone-500 hover:text-[#B24E3E]" onClick={() => setDeleteConfirm({ open: true, id: binding.id, title: `删除功能绑定 ${binding.label}` })}>
