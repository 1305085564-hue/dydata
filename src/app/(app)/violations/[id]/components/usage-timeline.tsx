              ...
              >
                ...
                <div className="rounded-xl border border-zinc-200 bg-white p-4 transition-colors hover:border-zinc-300">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <div className="flex items-center gap-2 text-[13px] font-normal text-zinc-700">
                  ...
                  <div className="mt-2 flex items-center gap-1.5 text-[12px] text-zinc-500">
                    <User2 className="size-3.5 text-zinc-500" strokeWidth={1.5} />
                    记录人 {recorderName}
                  </div>
...
function MetricCell({
  ...
  return (
    <div className="rounded-lg bg-zinc-50 px-3 py-2">
      <div className="flex items-center gap-1 text-[12px] font-normal text-zinc-500">
        <span className={accent ? "text-[#6FAA7D]" : "text-zinc-500"}>{icon}</span>
        {label}
      </div>
      <div
        className={
          accent
            ...
            : "mt-0.5 text-[13px] font-normal tracking-tight text-zinc-700 tabular-nums"
        }
      >
        {value}
      </div>
