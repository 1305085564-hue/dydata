    ...
    <AdminWorkspaceLayout
      ...
      actions={
        <div className="flex flex-wrap gap-2">
          <Link
            href="/violations"
            className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-zinc-200 bg-white px-3 text-[12px] font-medium text-zinc-700 transition-colors hover:border-zinc-300 hover:text-zinc-900 active:translate-y-0"
          >
