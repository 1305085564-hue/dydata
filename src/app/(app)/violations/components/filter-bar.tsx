  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <select
        ...
        className="h-8 cursor-pointer rounded-lg border border-zinc-200 bg-white px-2.5 text-[12px] text-zinc-700 outline-none transition-colors focus:border-zinc-500 focus:shadow-sm focus:ring-1 focus:ring-zinc-900/5"
      >
      ...
      {hasActiveFilters ? (
        <button
          type="button"
          onClick={handleReset}
          className="inline-flex items-center gap-1 text-[12px] text-zinc-500 transition-colors hover:text-zinc-700 active:translate-y-0"
        >
