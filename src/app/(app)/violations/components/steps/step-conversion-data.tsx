      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input
            ...
            autoFocus
            className="h-14 rounded-xl border-transparent bg-zinc-100/70 text-[18px] font-semibold tabular-nums text-zinc-800 placeholder:text-[14px] placeholder:font-normal focus:border-zinc-200 focus:bg-white focus:ring-1 focus:ring-zinc-950/5"
          />
        </div>
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="例如 180"
            className={cn(
              "h-14 rounded-xl border-transparent bg-zinc-100/70 text-[18px] font-semibold tabular-nums text-zinc-800 placeholder:text-[14px] placeholder:font-normal focus:border-zinc-200 focus:bg-white focus:ring-1 focus:ring-zinc-950/5",
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:gap-10">
        <div>
          ...
          <p className="mt-2 flex items-baseline gap-1 leading-none tabular-nums">
            {conversionRate === null ? (
              <span className="text-[24px] font-semibold text-zinc-300">—</span>
            ) : (
              <>
                <MotionNumber
                  value={conversionRate * 100}
                  format={(n) => n.toFixed(2)}
                  className="text-[28px] font-semibold text-zinc-800"
                />
