  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <Label htmlFor="script_text" className="text-[12px] font-normal text-zinc-500">
        ...
        <Textarea
          ...
          autoFocus
          className="min-h-[170px] resize-none rounded-xl border border-zinc-200 bg-zinc-50 text-[13px] leading-[1.6] focus:border-zinc-500 focus:bg-white focus:shadow-sm focus:ring-1 focus:ring-zinc-900/5"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          <Upload className="size-5 stroke-[1.5] text-zinc-500" />
                ...
                {screenshots.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {idx === 0 ? (
                        <span className="absolute left-1 top-1 inline-flex items-center rounded bg-zinc-900/70 px-1 py-0.5 text-[12px] font-medium tracking-[0.12em] text-white backdrop-blur-sm">
                          封面
                        </span>
                      ) : null}
