  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-[18px] font-medium tracking-tight text-stone-700">添加新账号</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="account-name" className="text-[13px] font-medium text-stone-700">账号备注名</Label>
            <Input
              id="account-name"
              value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="content-direction" className="text-[13px] font-medium text-stone-700">出镜 / 图文方向（选填）</Label>
            <Input
