    ...
    return (
      <div className="space-y-3">
        ...
        <section className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5">
          <h2 className="mb-3 text-[24px] font-medium tracking-tight text-zinc-900">提交日报</h2>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5">
        ...
        {accounts.length > 1 ? (
          <div className="mb-4 space-y-2">
            <label htmlFor="dashboard-account-switch" className="text-[13px] font-medium text-zinc-700">
              选择要提交的账号
            </label>
            <select
              ...
              className="flex h-10 w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-[13px] text-zinc-700 outline-none transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)] focus-visible:ring-1 focus-visible:ring-zinc-900/5"
            >
