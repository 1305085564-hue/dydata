        ...
        {checkpoints.map((checkpoint, index) => {
          ...
          return (
            ...
            >
              <div
                className={cn(
                  "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border bg-white text-zinc-400 transition-colors",
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-xs font-medium text-zinc-700">{checkpoint.name}</p>
                <p className="text-[10px] text-zinc-400 font-mono">{checkpoint.time}</p>
              </div>
            </button>
          );
        })}
