    ...
    <>
      ...
      >
        <Card className={cn(
          ...
          embeddedChrome
            ? "max-w-[1360px] rounded-none border-none bg-transparent shadow-none"
            : "max-w-[1360px] rounded-2xl border border-zinc-200/60 bg-zinc-50 shadow-[0_8px_30px_rgb(0,0,0,0.04)]",
        )}>
          {!embeddedChrome ? (
