  ...
  return (
    <>
      <Button
        ...
        className={cn(
          triggerVariant === "card"
            ...
            : "h-8 border-[#E2E2DF] px-3 text-[12px] font-medium text-[#292524] shadow-xs transition-colors duration-100 ease-out hover:border-[#E2E2DF] hover:bg-white active:scale-[0.99] active:duration-120",
          triggerClassName,
        )}
      >
        {triggerVariant === "card" ? (
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="flex flex-col overflow-hidden rounded-2xl border border-[#E2E2DF] bg-white/98 p-0 shadow-claude-dialog sm:max-w-4xl max-sm:max-w-none max-sm:w-full max-sm:h-dvh max-sm:max-h-none max-sm:rounded-none">
        ...
        <DialogTitle className="text-lg font-medium text-[#1C1917]">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="group inline-flex items-center gap-1 rounded-md border border-transparent bg-[#D97757]/10 px-2 py-1 text-[11.5px] font-medium text-[#D97757] shadow-2xs transition-colors duration-100 hover:bg-[#EBEBE9] hover:text-[#1C1917] active:scale-[0.99] active:duration-120 cursor-pointer shrink-0"
                >
              ...
              <div className="relative overflow-hidden rounded-xl border border-[#E2E2DF] bg-white p-3.5 shadow-2xs">
                <SubmissionCalendar
                  today={today}
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-1.5">
                  ...
                  {selectedDates.length > 0 ? (
                    <div className="rounded-xl border border-[#E2E2DF] bg-[#F1F1F0] p-3">
                      <div className="flex flex-wrap gap-1.5">
                        {selectedDates.map((date) => (
                          <span
                            key={date}
                            className="inline-flex items-center rounded-full border border-[#E2E2DF] bg-white px-2.5 py-0.5 text-[12px] font-medium tabular-nums text-[#292524] shadow-2xs"
                          >
                            {date}
                          </span>
                        ))}
                    ...
                    <div className={cn("flex h-16 items-center justify-center rounded-xl border border-dashed border-[#E2E2DF] bg-[#F1F1F0] text-[12.5px] text-[#78716C]", dateError && "border-[#C0685C]/40 ring-1 ring-[#C0685C]/40")}>
                      尚未选择任何日期
                    </div>
                  )}
                ...
                {remindCountLoading && (
                  <div className="space-y-2">
                    <div className="h-10 rounded-lg bg-[#F1F1F0]" />
                    <div className="h-10 rounded-lg bg-[#F1F1F0]" />
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    className={cn(
                      "h-[100px] w-full resize-none rounded-xl border border-[#E2E2DF] bg-white/50 px-3.5 py-2.5 text-[13px] leading-[1.7] text-[#292524] shadow-input transition-colors duration-150 ease-out placeholder:text-[#78716C]/60 hover:border-[#78716C]/40 focus-visible:border-[#78716C] focus-visible:bg-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#D97757]/25 focus-visible:ring-offset-0",
          ...
          <DialogFooter className="flex-row items-center justify-end gap-3 border-t border-[#E2E2DF]/80 px-6 py-4">
            <Button
              type="button"
              variant="ghost"
              size="l"
              ...
              disabled={isPending}
              className="h-10 px-5 text-[#292524] hover:bg-[#EBEBE9] hover:text-[#1C1917]"
            >
              取消
            </Button>
            <Button
