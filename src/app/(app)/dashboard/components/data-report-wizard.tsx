...
export function DataReportWizard({
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 py-2">
      ...
      <motion.div layout className="relative overflow-hidden rounded-xl border border-zinc-200 bg-white p-8">
                ...
                <div className="relative" ref={popoverRef}>
                  <button
                    ...
                    className={cn(
                      ...
                      showMissing ? "bg-zinc-50" : "hover:bg-zinc-50",
                    )}
                        ...
                        <div className="space-y-0.5">
                          {missingItems.map((item) => (
                            <button
                              ...
                              className="block w-full rounded-lg px-2.5 py-2 text-left text-[13px] text-zinc-700 transition-[background-color,color] duration-150 hover:bg-zinc-50 hover:text-zinc-700"
                            >
                              {item.label}
                            </button>
                          ))}
              ...
              {onCancel ? (
                <button
                  ...
                  className={cn(
                    ...
                    isSubmitting ? "cursor-not-allowed opacity-50" : "hover:bg-zinc-100 hover:text-zinc-700",
                  )}
                >
                  取消
                </button>
            ...
            <div className="flex shrink-0 flex-col items-center gap-2 px-2">
              <motion.div
                ...
                className={cn(
                  ...
                  state === "upcoming" && "bg-zinc-100 text-zinc-500",
                )}
              >
                {isCompleted ? (
              ...
              <span
                className={cn(
                  ...
                  isCurrent ? "text-zinc-700" : isSkipped ? "text-zinc-500" : "text-zinc-500",
                )}
              >
