...
export function QuickExemptionButton({
  ...
  const cardPending =
    "!h-auto min-h-[44px] sm:min-h-0 sm:!h-8 rounded-lg border border-[#E5E0D6]/80 bg-[#F5F3EE]/70 px-3 py-2 text-[12px] font-medium text-[#292524] transition-colors duration-100 ease-out hover:bg-[#F5F3EE] hover:text-[#1C1917] active:scale-[0.985] active:duration-75 [&>svg]:text-[#D99E55] [&>svg]:animate-pulse cursor-pointer";
  const card =
    "!h-auto min-h-[44px] sm:min-h-0 sm:!h-8 rounded-lg border border-[#E5E0D6] bg-white px-3 py-2 text-[12px] font-medium text-[#292524] transition-colors duration-100 ease-out hover:border-[#E5E0D6] hover:bg-[#FBF9F5] hover:text-[#1C1917] active:scale-[0.985] active:duration-75 focus-visible:ring-1 focus-visible:ring-[#1C1917]/5 cursor-pointer";
