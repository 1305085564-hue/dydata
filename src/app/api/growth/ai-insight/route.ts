...
import { buildGrowthInsightPromptAsync, GROWTH_INSIGHT_PROMPT_VERSION } from "@/lib/ai/growth-prompts";
...
export async function POST(request: NextRequest) {
  ...
  try {
    const prompt = await buildGrowthInsightPromptAsync(inputBundle);
