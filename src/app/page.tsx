      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-12 2xl:max-w-[88rem]">
        ...
        <header className="flex items-center justify-between border-b border-[#E2E2DF]/70 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="inline-flex items-center justify-center rounded-lg bg-[#F1F1F0] px-3.5 py-1.5 text-[13px] font-medium text-[#292524] transition-colors hover:bg-[#EBEBE9]"
            >
              申请加入团队
            </Link>
          </div>
        ...
        <section className="grid grid-cols-1 items-center gap-12 py-14 md:grid-cols-12 md:gap-12 md:py-24 2xl:gap-16">
          ...
          <div className="space-y-8 md:col-span-6 lg:col-span-7">
            ...
            <div className="flex flex-col gap-3.5 sm:flex-row sm:items-center">
              ...
              <Link
                href="/register"
                className="inline-flex items-center justify-center rounded-lg border border-[#E2E2DF] bg-white px-5 py-2.5 text-[13px] font-medium text-[#292524] shadow-2xs transition-colors hover:bg-[#EBEBE9]"
              >
                申请加入团队
              </Link>
            </div>
        ...
        <section className="border-t border-[#E2E2DF] py-16 lg:py-20">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {/* Pillar 1 */}
            <div className="flex flex-col justify-between rounded-xl border border-[#E2E2DF] bg-white p-6 shadow-2xs">
              ...
              <div className="mt-6 border-t border-[#E2E2DF]/60 pt-3 text-[12px] font-medium text-[#43718E]">
                解决：漏发漏报、考勤失真
              </div>
            </div>
