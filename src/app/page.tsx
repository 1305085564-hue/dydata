      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-12 2xl:max-w-[88rem]">
        ...
        <section className="grid grid-cols-1 items-center gap-12 py-12 md:grid-cols-2 md:gap-16 md:py-24 2xl:gap-20">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-block border-t border-zinc-200 pt-6">
          ...
          <div className="relative">
            <div className="flex flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white">
              {/* Window chrome */}
              <div className="flex h-10 items-center gap-1.5 border-b border-zinc-200 px-4">
              ...
              <div className="space-y-5 p-6">
                <div className="flex items-end justify-between">
                  <div className="space-y-1.5">
                    ...
                    <div className="h-5 w-32 rounded bg-zinc-900/[0.06]" />
                  </div>
                  <div className="h-8 w-20 rounded-md bg-[#D97757]/20" />
                </div>
                {/* Chart bars */}
                <div className="flex h-32 items-end gap-3">
                  <div className="h-[40%] flex-1 rounded-t bg-zinc-100" />
                  <div className="h-[60%] flex-1 rounded-t bg-zinc-100" />
                  <div className="h-[90%] flex-1 rounded-t bg-[#D97757]/80" />
                  <div className="h-[50%] flex-1 rounded-t bg-zinc-100" />
                  <div className="h-[75%] flex-1 rounded-t bg-zinc-100" />
                  <div className="h-[45%] flex-1 rounded-t bg-zinc-100" />
                  <div className="h-[85%] flex-1 rounded-t bg-zinc-100" />
                </div>
                {/* List items */}
                <div className="space-y-2.5">
                  <div className="flex items-center gap-3 rounded-lg border border-zinc-200 p-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="h-2 w-1/4 rounded bg-zinc-100/50" />
                    </div>
                  </div>
                  <div className="flex items-center gap-3 rounded-lg border border-zinc-200 p-3">
                    <div className="h-8 w-8 rounded bg-zinc-100" />
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="h-2 w-1/5 rounded bg-zinc-100/50" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Float card */}
            <div className="absolute -bottom-4 -left-4 hidden rounded-xl border border-zinc-200 bg-white p-4 md:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-medium text-zinc-700">+240.5%</p>
                  <p className="text-[12px] text-zinc-500">昨日播放增长率</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="border-t border-zinc-200 py-24 2xl:py-28">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 2xl:gap-8">
            {/* Card 1 */}
            <div className="group rounded-2xl border border-zinc-200 bg-white p-8 transition-colors duration-150 hover:bg-zinc-50">
        ...
        {/* Footer */}
        <footer className="flex flex-col items-center justify-between gap-4 border-t border-zinc-200 py-12 md:flex-row md:gap-0">
          <div className="flex items-center gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded bg-[#D97757]">
              <Zap className="size-3 fill-white text-white" />
            </div>
            <p className="text-[13px] font-normal text-zinc-700">
              DYData
              <span className="ml-1 text-[12px] text-zinc-500">© 2025</span>
            </p>
          </div>
          <a
            href="mailto:1305085564@qq.com"
            className="text-[13px] text-zinc-500 transition-colors hover:text-[#D97757]"
          >
            1305085564@qq.com
          </a>
        </footer>
