...
export function AuthShell({ eyebrow = "DYData", title, subtitle, children }: AuthShellProps) {
  return (
    <div className="flex min-h-screen min-h-dvh items-center justify-center px-6 py-12 bg-[#FCFCFB]">
      <motion.div
      ...
      >
        ...
        <div className="mb-8 space-y-2 text-center">
          ...
          <h1 className="font-serif text-[1.75rem] leading-[1.20] font-medium tracking-tight text-[#1C1917]">
            {title}
          </h1>
          {subtitle ? (
