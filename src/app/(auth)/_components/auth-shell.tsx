  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6 py-12">
      <motion.div
        ...
        className="relative w-full max-w-[440px] overflow-hidden rounded-2xl border border-zinc-200 bg-white px-8 py-10 shadow-[0_8px_30px_rgba(28,25,23,0.025),0_1px_3px_rgba(28,25,23,0.01)] hover:shadow-[0_24px_48px_rgba(28,25,23,0.05)] hover:-translate-y-[2px] transition-all duration-300"
      >
