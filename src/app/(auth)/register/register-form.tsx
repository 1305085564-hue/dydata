      ...
      <form action={formAction} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            required
            type="text"
            className="focus:bg-white border-[#E2E2DF] text-[13px]"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Input
              ...
              className="focus:bg-white border-[#E2E2DF] pr-9 text-[13px]"
            />
            <button
              type="button"
            ...
            <div className="flex items-center justify-between gap-3 pt-1">
              <div className="flex flex-1 gap-1">
                {passwordStrengthConfig.map((item, idx) => (
                  <span
                    key={item.level}
                    className="h-[3px] flex-1 rounded-full bg-[#F1F1F0] transition-[background-color] duration-150 ease-[cubic-bezier(0.4,0,0.2,1)]"
                    style={
